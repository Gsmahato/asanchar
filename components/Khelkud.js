              ...
              <div className={styles.Enter_spot_news}>
                <Link href={`/news/${khelnews.id}`}>
                  <Image
                    ...
                    src={`https://prajjwalacharya.pythonanywhere.com/${khelnews.image1}`}
                    alt="khelkud"
                    width={700}
                    height={600}
                  />
                  <div className={styles.post_content}>
                    <h2 className={styles.M_title_text}>{khelnews.title}</h2>
                    <div className={styles.title_in}>
                      <div className={styles.M_post_hour}>
                        ...
                        <span>
                          {formatTime(getMinutesAgo(khelnews.created_at))}
                        </span>
                      </div>
                    </div>
                  </div>
            ...
            <div className={styles.span_4} key={knews.id}>
              <div className={styles.Enter_spot_news}>
                <Link href={`/news/${knews.id}`}>
                  <Image
                    className={styles.M_image}
                    src={`https://prajjwalacharya.pythonanywhere.com/${knews.image1}`}
                    alt="khelkud"
                    width={500}
                    height={400}
                  />
                  <div className={styles.post_content}>
                    <h2 className={styles.E_title_text}>{knews.title}</h2>
                    <div className={styles.title_in}>
                      <div className={styles.M_post_hour}>
                        <i>
                          <FaRegClock />
                        ...
                        <span>
                          {formatTime(getMinutesAgo(knews.created_at))}
                        </span>
                      </div>
                    </div>
                  </div>
